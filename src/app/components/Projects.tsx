        ...
        >
            <Tilt className="Tilt" tiltMaxAngleX={3} tiltMaxAngleY={3} scale={1}>
                <Element name='projects' className='flex justify-center mb-80' id='projects'>
                    <div className="gap-12 flex flex-row justify-center items-center max-w-auto p-5 px-16 rounded-2xl bg-gradient-to-r from-white/30 to-gray-100/30 backdrop-blur-md shadow-2xl border border-gray-300 hover:shadow-lg transition-shadow duration-300 ease-in-out">
                        <div className="flex flex-col items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-40">
                            ...
                            <ul className='p-2 list-none'>
                                <li className='py-4'>
                                    <a 
                                        ...
                                        className='border-slate-800 border-b-2 selection:none px-5 text-left block'
                                    >
                                        2024 - RedPost
                                    </a>
                                </li>
